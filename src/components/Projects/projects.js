    ...
    <section className="projects">
        ...
        <div className="projects__cards">
            ...
            <div className="projects__card">
                ...
                <p>"Simple React todo list app for task organization. Allows adding, completing, and deleting tasks with ease."
                </p>

                <a href="https://65b0bcd5a44229513bba18e1--lively-seahorse-40acc2.netlify.app/" target="_blank" className="button">Site</a>
                <a href="https://github.com/Srinivasareddy2108/TODO_List_Deploy" target="_blank" className="button">Code</a>
            </div>
